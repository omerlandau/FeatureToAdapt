...
def main():
    ...
    for i in range(1, 17):
        model_path = './snapshots/GTA2Cityscapes_reterain_adv_from_only_norm/GTA5_{0:d}.pth'.format(i*2000)
        save_path = './GTA_results/GTA2Cityscapes_reterain_adv_from_only_norm_{0:d}'.format(i*2000)
        args = get_arguments()
