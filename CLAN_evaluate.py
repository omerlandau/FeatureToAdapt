...
def main():
    ...
    if args.restore_from[:4] == 'http' :
        ...
        saved_state_dict = torch.load(args.restore_from_second, map_location="cuda:{0}".format(args.gpu))
        saved_state_dict_2 = torch.load(args.restore_from, map_location="cuda:{0}".format(args.gpu))
