...
def split_all_imgaes(images_p, labels_p, type, direct_l, direct_i):
    ...
    print("done PCA")
    tsne = TSNE(n_components=2, learning_rate=130, perplexity=20, angle=0.2, verbose=2, n_iter=5000).fit_transform(X)
...
def main():
    ...
    with open("./GTA_tsne_p20", 'wb') as pfile:
    ...
    with open("./City_tsne_p20", 'wb') as pfile:
