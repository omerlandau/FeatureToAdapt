...
if __name__ == "__main__":
    with open("mIoU_result/GTA2Cityscapes_norm_layer3_00015_18power_damp_MIoU_till_56.csv","a+",newline="") as datacsv:
        csvwriter = csv.writer(datacsv,dialect = ("excel"))
        for i in range(1, 29):
            gt_dir = './data/CitySpaces/gtFine/val'
            pred_dir = './result/GTA2Cityscapes_norm_layer3_00015_18power_damp_{0:d}'.format(i*2000)
